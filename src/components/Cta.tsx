...
// Generated: 2025-08-22T09:55:04.410Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "24/7", label: "VIP Client Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Work with Amanda Foster, a top luxury real estate agent, to find 
                or sell your exclusive property in the heart of Beverly Hills.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Schedule a complimentary meeting with Amanda
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Luxury Expertise</h3>
              <p className="text-sm text-muted-foreground">
                Amanda's deep knowledge of the Beverly Hills market
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Amanda's tailored approach for each client's needs
              </p>
            </div>
          </div>
        </div>
