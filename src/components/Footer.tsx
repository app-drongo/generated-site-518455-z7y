...
// Generated: 2025-08-22T09:55:03.756Z
// Section: footer
// Category: footer
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Luxury Homes", href: "/luxury-homes" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Specializing in luxury real estate in Beverly Hills, Amanda Foster offers unparalleled expertise and personalized service to help clients achieve their real estate goals.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@amandafosterluxuryhomes.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates on luxury homes and market trends. Unsubscribe anytime.
              </p>
            </div>
          </div>
